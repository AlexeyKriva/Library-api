package api.modsen.library.authmicroservice.config;
...
public class AuthAppConstants {
    ...
    public static final String INVALID_TOKEN_OR_INCORRECT_PASSWORD_MESSAGE = "Token invalid or incorrect password.";
